    ...
    async def analyze_text(
        ...
        **kwargs: Any
        ...
        if api_version == '2022-05-01':
            ...
            from ..v2023_04_01.aio.operations import TextAnalyticsClientOperationsMixin as OperationClass
        else:
    ...
    async def begin_health(
        ...
        **kwargs: Any
        ...
        :param logging_opt_out: (Optional) If set to true, you opt-out of having your text input logged
         ...
         notes-and-codes at https://aka.ms/cs-compliance for additional details, and Microsoft Responsible AI
