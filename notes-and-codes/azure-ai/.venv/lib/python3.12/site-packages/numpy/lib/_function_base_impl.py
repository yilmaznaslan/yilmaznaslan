...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
    ...
    See the notes-and-codes for an outline of the algorithm.
    ...
    ddof : int, optional
        ...
        the simple average. See the notes-and-codes for the details. The default value
        is ``None``.
...
def percentile(a,
    ...
    method : str, optional
        ...
        See the notes-and-codes for explanation.  The options sorted by their R type
    ...
    keepdims : bool, optional
     ...
     weights : array_like, optional
        ...
        See the notes-and-codes for more details.
